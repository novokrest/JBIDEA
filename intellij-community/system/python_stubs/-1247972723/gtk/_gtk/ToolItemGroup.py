...
class ToolItemGroup(Container, ToolShell):
    ...
    Signals from GObject:
      notify (GParam)
    """
    def get_collapsed(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def get_header_relief(self, *args, **kwargs): # real signature unknown
        pass

    def get_item_position(self, *args, **kwargs): # real signature unknown
        pass
    ...
    def set_collapsed(self, *args, **kwargs): # real signature unknown
        pass

    def set_ellipsize(self, *args, **kwargs): # real signature unknown
        pass

    def set_header_relief(self, *args, **kwargs): # real signature unknown
        pass

    def set_item_position(self, *args, **kwargs): # real signature unknown
        pass
