...
class TreeSortable(__gobject.GInterface):
    # no doc
    @classmethod
    def do_get_sort_column_id(cls, *args, **kwargs): # real signature unknown
        pass
    ...
    @classmethod
    def do_set_default_sort_func(cls, *args, **kwargs): # real signature unknown
        pass
    ...
    @classmethod
    def do_set_sort_func(cls, *args, **kwargs): # real signature unknown
        pass
