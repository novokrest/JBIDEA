...
# from /usr/lib/python2.7/dist-packages/PyQt4/QtAssistant.so
# by generator 1.135
# no doc
...
class QAssistantClient(__PyQt4_QtCore.QObject):
    ...
    def setArguments(self, QStringList): # real signature unknown; restored from __doc__
        """ QAssistantClient.setArguments(QStringList) """
        pass

    def showPage(self, QString): # real signature unknown; restored from __doc__
