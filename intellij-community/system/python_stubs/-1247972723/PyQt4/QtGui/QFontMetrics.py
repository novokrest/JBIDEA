...
class QFontMetrics(): # skipped bases: <type 'sip.simplewrapper'>
    ...
    def charWidth(self, QString, p_int): # real signature unknown; restored from __doc__
    ...
    def elidedText(self, QString, Qt_TextElideMode, p_int, int_flags=0): # real signature unknown; restored from __doc__
    ...
    def inFontUcs4(self, p_int): # real signature unknown; restored from __doc__
        """ QFontMetrics.inFontUcs4(int) -> bool """
        return False
