...
class QChar(): # skipped bases: <type 'sip.simplewrapper'>
    ...
    Center = 3
    Circle = 8
    CombiningClass = None # (!) real value is ''
    Combining_Above = 230
    ...
    Compat = 16
    Decomposition = None # (!) real value is ''
    DirAL = 13
    DirAN = 5
    DirB = 7
    DirBN = 18
    ...
    Separator_Space = 7
    Small = 14
    SpecialCharacter = None # (!) real value is ''
    Square = 15
    Sub = 10
    Super = 9
    Symbol_Currency = 28
    ...
    Symbol_Modifier = 29
    Symbol_Other = 30
    UnicodeVersion = None # (!) real value is ''
    Unicode_1_1 = 1
    Unicode_2_0 = 2
    Unicode_2_1_2 = 3
    Unicode_3_0 = 4
