...
class QString(): # skipped bases: <type 'sip.simplewrapper'>
    ...
    KeepEmptyParts = 0
    NormalizationForm = None # (!) real value is ''
    ...
    SectionDefault = 0
    SectionFlag = None # (!) real value is ''
    SectionFlags = None # (!) real value is ''
    SectionIncludeLeadingSep = 2
    SectionIncludeTrailingSep = 4
    SectionSkipEmpty = 1
    SkipEmptyParts = 1
    SplitBehavior = None # (!) real value is ''
