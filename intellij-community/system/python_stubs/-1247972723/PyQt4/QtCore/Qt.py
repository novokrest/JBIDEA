...
class Qt(): # skipped bases: <type 'sip.wrapper'>
    # no doc
    def convertFromPlainText(self, QString, Qt_WhiteSpaceMode_mode=None): # real signature unknown; restored from __doc__
        """ Qt.convertFromPlainText(QString, Qt.WhiteSpaceMode mode=Qt.WhiteSpacePre) -> QString """
        return QString

    def escape(self, QString): # real signature unknown; restored from __doc__
        """ Qt.escape(QString) -> QString """
        return QString

    def mightBeRichText(self, QString): # real signature unknown; restored from __doc__
        """ Qt.mightBeRichText(QString) -> bool """
        return False
