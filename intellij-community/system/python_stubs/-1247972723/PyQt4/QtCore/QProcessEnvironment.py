...
class QProcessEnvironment(): # skipped bases: <type 'sip.simplewrapper'>
    ...
    def keys(self): # real signature unknown; restored from __doc__
        """ QProcessEnvironment.keys() -> QStringList """
        return QStringList
    ...
    def value(self, QString, QString_defaultValue=None, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
