...
class dns(__dcerpc.ClientConnection):
    ...
    DNS records
    """
    def decode_dns_name_packet(self, packet): # real signature unknown; restored from __doc__
        """ S.decode_dns_name_packet(packet) -> None """
        pass
...
class hinfo_record(__talloc.Object):
    # no doc
    def __init__(self, *args, **kwargs): # real signature unknown
        pass
    ...
    cpu_length = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    os = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    os_length = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
