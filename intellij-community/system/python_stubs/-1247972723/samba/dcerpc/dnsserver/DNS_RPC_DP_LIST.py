...
class DNS_RPC_DP_LIST(__talloc.Object):
    # no doc
    ...
    DpArray = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    dwDpCount = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
