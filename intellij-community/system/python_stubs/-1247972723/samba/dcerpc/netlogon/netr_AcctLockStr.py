...
class netr_AcctLockStr(__talloc.Object):
    # no doc
    ...
    bad_attempt_lockout = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    reset_count = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
