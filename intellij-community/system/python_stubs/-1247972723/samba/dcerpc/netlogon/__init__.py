...
NETR_TRUST_ATTRIBUTE_CROSS_ORGANIZATION = 16

NETR_TRUST_ATTRIBUTE_FOREST_TRANSITIVE = 8

NETR_TRUST_ATTRIBUTE_NON_TRANSITIVE = 1

NETR_TRUST_ATTRIBUTE_QUARANTINED_DOMAIN = 4

NETR_TRUST_ATTRIBUTE_TREAT_AS_EXTERNAL = 64

NETR_TRUST_ATTRIBUTE_UPLEVEL_ONLY = 2

NETR_TRUST_ATTRIBUTE_WITHIN_FOREST = 32
