...
class dnsp(__dcerpc.ClientConnection):
    ...
    DNSP interfaces
    """
    def decode_DnsProperty(self, blob): # real signature unknown; restored from __doc__
        """ S.decode_DnsProperty(blob) -> None """
        pass

    def decode_DnssrvRpcRecord(self, blob): # real signature unknown; restored from __doc__
        """ S.decode_DnssrvRpcRecord(blob) -> None """
        pass
