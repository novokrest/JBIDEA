...
class NETLOGON_SAM_LOGON_RESPONSE(__talloc.Object):
    # no doc
    ...
    pdc_ip = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
    ...
    zero_uuid = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
