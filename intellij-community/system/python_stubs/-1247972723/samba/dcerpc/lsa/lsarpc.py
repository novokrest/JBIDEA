...
class lsarpc(__dcerpc.ClientConnection):
    ...
    def lsaRQueryForestTrustInformation(self, handle, trusted_domain_name, unknown): # real signature unknown; restored from __doc__
        """ S.lsaRQueryForestTrustInformation(handle, trusted_domain_name, unknown) -> forest_trust_info """
        pass
