...
class ObjectAttribute(__talloc.Object):
    # no doc
    ...
    root_dir = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    sec_desc = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    sec_qos = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
