...
class DsReplicaUpdateRefsRequest1(__talloc.Object):
    # no doc
    ...
    dest_dsa_dns_name = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    dest_dsa_guid = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
