...
class DsReplicaLinkedAttribute(__talloc.Object):
    # no doc
    ...
    meta_data = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    originating_add_time = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
