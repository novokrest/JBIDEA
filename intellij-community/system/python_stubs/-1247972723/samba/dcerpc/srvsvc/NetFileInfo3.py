...
class NetFileInfo3(__talloc.Object):
    # no doc
    ...
    fid = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    num_locks = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
